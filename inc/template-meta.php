 ...
 * @return array
 */
function caldera_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	if ( ! caldera_is_meta_visible( $meta, $context ) ) {
		return;
	}
	...
	$default_config = apply_filters( 'caldera_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'caldera_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'caldera' ) . $network['name'],
