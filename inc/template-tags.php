...
function caldera_is_top_panel_visible() {
	$message = get_theme_mod( 'top_panel_text', caldera_theme()->customizer->get_default( 'top_panel_text' ) );
	$search  = get_theme_mod( 'top_panel_search', caldera_theme()->customizer->get_default( 'top_panel_search' ) );
	$menu    = has_nav_menu( 'top' );

	$conditions = apply_filters( 'caldera_top_panel_visibility_conditions', array( $message, $search, $menu ) );
