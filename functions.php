...
if ( ! class_exists( 'Caldera_Theme_Setup' ) ) {
	...
	class Caldera_Theme_Setup {
    		...
    		'base_url' => CHERRY_URI,
				...
				'modules'  => array(
					...
					'cherry-utility' => array(
						...
						'args'     => array(
							'meta_key' => array(
								'term_thumb' => 'caldera-thumb-418-304'
							),
						)
					),
		...
		public function theme_support() {
			...
			add_theme_support( 'custom-background', array( 'default-color' => '1a1a1a', ) );
		...
		public function register_assets() {
			wp_register_script( 'jquery-slider-pro', CALDERA_THEME_JS . '/jquery.sliderPro.min.js', array( 'jquery' ), '1.2.4', true );
